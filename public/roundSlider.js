...
(function ($, window, undefined) {
  ...
  RoundSlider.prototype = {
    ...
    _getAngleValue (point, center, isDrag) {
    ...
    _bind (element, _event, handler) {
          $(element).bind(_event, $.proxy(handler, this));
      },
    _unbind (element, _event, handler) {
...
instance = $.data(that, pluginName);
      if (!instance) {
        let _this = new RoundSlider(that, options);
